        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center">
          ...
          <div className="w-full lg:w-2/5">
            ...
            <h2 className="text-2xl md:text-3xl text-slate-600 dark:text-slate-300 mb-6 max-w-2xl">
              Maßgeschneiderte Datenlösungen für Krebsregister und
              Gesundheitsinstitutionen
            </h2>

            <p className="text-lg text-slate-600 dark:text-slate-400 mb-8">
              Wir entwickeln maßgeschneiderte Datenlösungen für Krebsregister
              und Gesundheitsinstitutionen. Modern, flexibel und
              kosteneffizient, ohne Kompromisse bei Qualität und
              Datensicherheit.
            </p>
          ...
          <div className="w-full mt-12 lg:mt-0">
            <div className="relative w-full lg:w-[32vw] max-w-3xl ml-auto mr-0 lg:translate-x-8 rounded-xl overflow-hidden shadow-2xl border-2 border-emerald-500/30 dark:border-emerald-400/30">
              <video
                autoPlay
                loop
                muted
